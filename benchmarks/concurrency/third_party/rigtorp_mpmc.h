#ifndef URLICHT_BM_CONCURRENCY_THIRD_PARTY_RIGTORP_MPMC_H
#define URLICHT_BM_CONCURRENCY_THIRD_PARTY_RIGTORP_MPMC_H
...
#endif //URLICHT_BM_CONCURRENCY_THIRD_PARTY_RIGTORP_MPMC_H
