...
TEST(UpperBound, EmptyRange) {
    std::vector<int> v;
    auto it = urlicht::algorithm::upper_bound(v.begin(), v.end(), 42);
    EXPECT_EQ(it, v.end());
}
...
TEST(UpperBound, BasicAscending) {
    ...
    EXPECT_EQ(urlicht::algorithm::upper_bound(v.begin(), v.end(), 0), v.begin());
    EXPECT_EQ(urlicht::algorithm::upper_bound(v.begin(), v.end(), 1), v.begin() + 1);
    EXPECT_EQ(urlicht::algorithm::upper_bound(v.begin(), v.end(), 4), v.begin() + 2);
    EXPECT_EQ(urlicht::algorithm::upper_bound(v.begin(), v.end(), 9), v.end());
    EXPECT_EQ(urlicht::algorithm::upper_bound(v.begin(), v.end(), 10), v.end());
}

TEST(UpperBound, WithDuplicates) {
    std::vector<int> v{1, 2, 2, 2, 3, 5};

    auto it = urlicht::algorithm::upper_bound(v.begin(), v.end(), 2);
...
TEST(UpperBound, RangeOverload) {
    ...
    auto it = urlicht::algorithm::upper_bound(v, 2);
...
TEST(UpperBound, Projection) {
    ...
    auto it =
        urlicht::algorithm::upper_bound(v.begin(), v.end(), 2, std::less<>{}, &Record::key);
...
TEST(UpperBound, CustomComparator) {
    ...
    auto it = urlicht::algorithm::upper_bound(v.begin(), v.end(), 7, std::greater<>{});
    EXPECT_EQ(std::distance(v.begin(), it), 4);
}
...
TEST(UpperBound, MatchesSTDOverRandInputs) {
    ...
    for (int trial = 0; trial < 500; ++trial) {
        ...
        for (int q = -2050; q <= 2050; ++q) {
            auto it_u = urlicht::algorithm::upper_bound(v.begin(), v.end(), q);
