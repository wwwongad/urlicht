...
TEST(ArenaResource, AllocAndAlign) {
    ...
    urlicht::memory::pmr::arena_resource<> arena2;
...
TEST(ArenaResource, PMRVector) {
    urlicht::memory::pmr::arena_resource<> arena(65536);
...
TEST(ArenaResource, NestedPMR) {
    ...
    urlicht::memory::pmr::arena_resource<> arena(1 << 20);
...
TEST(ArenaResource, FrameLoopWithReset) {
    urlicht::memory::pmr::arena_resource<> arena(1 << 16);
...
TEST(ArenaResource, EqualityComparison) {
    urlicht::memory::pmr::arena_resource<> a1, a2;
