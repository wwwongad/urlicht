...
#include <urlicht/functional/adaptive_move_only_function.h>
#include <memory>
#include <type_traits>
...
using move_only_func = urlicht::adaptive_move_only_function<int() noexcept, 64, alignof(std::max_align_t)>;
...
static_assert(urlicht::is_urlicht_adaptive_move_only_function_v<move_only_func>);
