...
namespace urlicht::memory {
     ...
     *
     * @note: - This class is typeless and thus incompatible with std::allocator_traits. Use urlicht::memory::arena_view
    ...
    private:
        ...
        UL_NO_UNIQUE_ADDRESS std::conditional_t<UseUpstream,
            detail::chunk_footer*, std::monostate> chunk_footer_{};
