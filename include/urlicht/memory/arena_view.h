...
namespace urlicht::memory {
    /**
     * @brief A non-owning view to an allocator instance (either of type urlicht::memory::arena or urlicht::memory::concurrent_arena),
     ...
     */
    template <urlicht::concepts::object T, bool UnsafeAllocInit, typename Arena>
    class arena_view {
        static_assert(urlicht::is_urlicht_arena_view_compatible_v<Arena>,
            "Arena should be an instantiation of urlicht::memory::arena or urlicht::memory::concurrent_arena");
    public:
    ...
    public:
        ...
        /**
         * @brief Constructs with an urlicht::memory::arena by holding a reference to it.
         * @param arena An urlicht::memory::arena instance from which arena_view will allocate memory subsequently.
         */
