#ifndef URLICHT_ADAPTIVE_FUNCTION_BASE_H
#define URLICHT_ADAPTIVE_FUNCTION_BASE_H
...
namespace urlicht::functional_detail {
...
#endif //URLICHT_ADAPTIVE_FUNCTION_BASE_H
